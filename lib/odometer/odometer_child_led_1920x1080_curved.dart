...
class GameOdometerChildLed1920x1080Curved extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed1920x1080Curved({
    super.key,
  ...
  @override
  _GameOdometerChildLed1920x1080CurvedState createState() => _GameOdometerChildLed1920x1080CurvedState();
}

class _GameOdometerChildLed1920x1080CurvedState extends State<GameOdometerChildLed1920x1080Curved> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed1920x1080Curved oldWidget) {
