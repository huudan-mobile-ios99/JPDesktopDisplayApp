...
class GameOdometerChildLed1920x1080MarX extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed1920x1080MarX({
    super.key,
  ...
  @override
  _GameOdometerChildLed1920x1080MarXState createState() => _GameOdometerChildLed1920x1080MarXState();
}

class _GameOdometerChildLed1920x1080MarXState extends State<GameOdometerChildLed1920x1080MarX> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed1920x1080MarX oldWidget) {
