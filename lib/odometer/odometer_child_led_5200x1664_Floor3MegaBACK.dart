...
class GameOdometerChildLed5200x1664LedFloor3MegaBACK extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed5200x1664LedFloor3MegaBACK({
    super.key,
  ...
  @override
  _GameOdometerChildLed5200x1664LedFloor3MegaBACKState createState() => _GameOdometerChildLed5200x1664LedFloor3MegaBACKState();
}

class _GameOdometerChildLed5200x1664LedFloor3MegaBACKState extends State<GameOdometerChildLed5200x1664LedFloor3MegaBACK> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed5200x1664LedFloor3MegaBACK oldWidget) {
 ...
 return ClipRect(
      child: RepaintBoundary(
        child: Column(
          ...
          children: [
             Transform.translate(
              offset: const Offset(0, 5), // Shift text down by 2 pixels
              child: textCustom(
            ...
            Container(
              ...
              width: ConfigCustom.fixWidth_HD_led_Floor3MegaBack / 2,
              height: ConfigCustom.odo_height_1920x1080_ledFloor3MegaBACK,
              child: Stack(
                children: [
                  Positioned(
                    top:  -ConfigCustom.odo_position_top_1920x1080_ledFloor3MegaBACK,
                    left: 0,
                    right: 0,
                      ...
                      builder: (context, value, child) {
                        return RepaintBoundary(
                          child: SlideOdometerTransition(
                            verticalOffset:  ConfigCustom.text_odo_letter_vertical_offset_1920x1080_ledFloor3MegaBACK,
                            groupSeparator: const Text(',', style:  textStyleOdo5200x1664Floor3MegaBACK,),
                            decimalSeparator: const Text('.', style:  textStyleOdo5200x1664Floor3MegaBACK,),
                            letterWidth:ConfigCustom.text_odo_letter_width_1920x1080_ledFloor3MegaBACK,
                            odometerAnimation: odometerAnimation,
                            numberTextStyle: textStyleOdo5200x1664Floor3MegaBACK,
                            decimalPlaces: 2,
                            integerDigits: 0,
                          ),
                        );
