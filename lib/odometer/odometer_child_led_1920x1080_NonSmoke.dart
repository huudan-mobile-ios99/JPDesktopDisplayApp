...
class GameOdometerChildLed1920x1080NonSmoke extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed1920x1080NonSmoke({
    super.key,
  ...
  @override
  _GameOdometerChildLed1920x1080NonSmokeState createState() => _GameOdometerChildLed1920x1080NonSmokeState();
}

class _GameOdometerChildLed1920x1080NonSmokeState extends State<GameOdometerChildLed1920x1080NonSmoke> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed1920x1080NonSmoke oldWidget) {
 ...
 return ClipRect(
      child: RepaintBoundary(
        child: Container(
          ...
          width: ConfigCustom.fixWidth_HD_led_curved / 2,
          height: ConfigCustom.odo_height_1920x1080_non_smoke,
          child: Stack(
            children: [
              Positioned(
                top:  -ConfigCustom.odo_position_top_1920x1080_non_smoke,
                left: 0,
                right: 0,
                  ...
                  builder: (context, value, child) {
                    return RepaintBoundary(
                      child: SlideOdometerTransition(
                        verticalOffset:  ConfigCustom.text_odo_letter_vertical_offset_1920x1080_non_smoke,
                        groupSeparator: const Text(',', style:  textStyleOdo1920x1080_Non_Smoke,),
                        decimalSeparator: const Text('.', style:  textStyleOdo1920x1080_Non_Smoke,),
                        letterWidth:ConfigCustom.text_odo_letter_width_1920x1080_non_smoke,
                        odometerAnimation: odometerAnimation,
                        numberTextStyle: textStyleOdo1920x1080_Non_Smoke,
                        decimalPlaces: 2,
                        integerDigits: 0,
                      ),
                    );
