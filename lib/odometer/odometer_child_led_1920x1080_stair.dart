...
class GameOdometerChildLed1920x1080 extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed1920x1080({
    super.key,
  ...
  @override
  _GameOdometerChildLed1920x1080State createState() => _GameOdometerChildLed1920x1080State();
}

class _GameOdometerChildLed1920x1080State extends State<GameOdometerChildLed1920x1080> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed1920x1080 oldWidget) {
    ...
    // CORRECT LOGIC ? NEVER use endValue as fallback!
    final shouldUseHive = _isFirstRun && widget.hiveValue > 0;
    final newStartValue = shouldUseHive ? widget.hiveValue : widget.startValue;
    currentValueNotifier.value = newStartValue;
  ...
  return ClipRect(
      child: RepaintBoundary(
        child: Container(
          ...
          width: ConfigCustom.fixWidth_HD_led_stair / 2,
          height: ConfigCustom.odo_height_1920x1080,
          child: Stack(
            children: [
              Positioned(
                top:  -ConfigCustom.odo_position_top_1920x1080,
                left: 0,
                right: 0,
                child: ValueListenableBuilder<double>(
                  valueListenable: currentValueNotifier,
                  builder: (context, value, child) {
                    // debugPrint('VALUE LISTENER $value');
                    ...
                    return RepaintBoundary(
                      child: SlideOdometerTransition(
                        verticalOffset:  ConfigCustom.text_odo_letter_vertical_offset_1920x1080,
                        groupSeparator: const Text(',', style:  textStyleOdo1920x1080,),
                        decimalSeparator: const Text('.', style:  textStyleOdo1920x1080,),
                        letterWidth:ConfigCustom.text_odo_letter_width_1920x1080,
                        odometerAnimation: odometerAnimation,
                        numberTextStyle: textStyleOdo1920x1080,
                        decimalPlaces: 2,
                        integerDigits: 0,
                      ),
                    );
