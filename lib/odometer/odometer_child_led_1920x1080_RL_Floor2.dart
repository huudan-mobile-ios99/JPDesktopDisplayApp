...
class GameOdometerChildLed1920x1080RLFloor2 extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed1920x1080RLFloor2({
    super.key,
  ...
  @override
  _GameOdometerChildLed1920x1080RLFloor2State createState() => _GameOdometerChildLed1920x1080RLFloor2State();
}

class _GameOdometerChildLed1920x1080RLFloor2State extends State<GameOdometerChildLed1920x1080RLFloor2> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed1920x1080RLFloor2 oldWidget) {
 ...
 return ClipRect(
      child: RepaintBoundary(
        child: Container(
          ...
          height: ConfigCustom.odo_height_1920x1080_RL_floor2,
          child: Stack(
            children: [
              Positioned(
                top:  -ConfigCustom.odo_position_top_1920x1080_RL_floor2,
                left: 0,
                right: 0,
                child: ValueListenableBuilder<double>(
                  ...
                  builder: (context, value, child) {
                    ...
                    return SlideOdometerTransition(
                      verticalOffset:  ConfigCustom.text_odo_letter_vertical_offset_1920x1080_RL_floor2,
                      groupSeparator: const Text(',', style:  textStyleOdo1920x1080RLFloor2,),
                      decimalSeparator: const Text('.', style:  textStyleOdo1920x1080RLFloor2,),
                      letterWidth:ConfigCustom.text_odo_letter_width_1920x1080_RL_floor2,
                      odometerAnimation: odometerAnimation,
                      numberTextStyle: textStyleOdo1920x1080RLFloor2, 
                      decimalPlaces: 2,
                      integerDigits: 0,
                    );
                  },
