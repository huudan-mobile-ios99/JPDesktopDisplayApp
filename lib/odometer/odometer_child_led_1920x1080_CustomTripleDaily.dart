...
class GameOdometerChildLed1920x1080CustomTripleDaily extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed1920x1080CustomTripleDaily({
    super.key,
  ...
  @override
  _GameOdometerChildLed1920x1080CustomTripleDailyState createState() => _GameOdometerChildLed1920x1080CustomTripleDailyState();
}

class _GameOdometerChildLed1920x1080CustomTripleDailyState extends State<GameOdometerChildLed1920x1080CustomTripleDaily> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed1920x1080CustomTripleDaily oldWidget) {
 ...
 return ClipRect(
      child: RepaintBoundary(
        child: Container(
          ...
          height: ConfigCustom.odo_height_1920x1080_ledCustomTRIPLEDAILY,
          child: Stack(
            children: [
              Positioned(
                top:  -ConfigCustom.odo_position_top_1920x1080_ledCustomTRIPLEDAILY,
                left: 0,
                right: 0,
                child: ValueListenableBuilder<double>(
                  ...
                  builder: (context, value, child) {
                    ...
                    return SlideOdometerTransition(
                      verticalOffset:  ConfigCustom.text_odo_letter_vertical_offset_1920x1080_ledCustomTRIPLEDAILY,
                      groupSeparator: const Text(',', style:  textStyleOdo1920x1080CustomTripleDaily,),
                      decimalSeparator: const Text('.', style:  textStyleOdo1920x1080CustomTripleDaily,),
                      letterWidth:ConfigCustom.text_odo_letter_width_1920x1080_ledCustomTRIPLEDAILY,
                      odometerAnimation: odometerAnimation,
                      numberTextStyle: textStyleOdo1920x1080CustomTripleDaily, 
                      decimalPlaces: 2,
                      integerDigits: 0,
                    );
                  },
