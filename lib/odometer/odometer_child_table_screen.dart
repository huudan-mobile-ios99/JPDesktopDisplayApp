...
class GameOdometerChildStyleFixedTable extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildStyleFixedTable({
    super.key,
  ...
  @override
  _GameOdometerChildStyleFixedTableState createState() => _GameOdometerChildStyleFixedTableState();
}

class _GameOdometerChildStyleFixedTableState extends State<GameOdometerChildStyleFixedTable> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildStyleFixedTable oldWidget) {
    ...
    return ClipRect(
      child: RepaintBoundary(
        child: Column(
          ...
          children: [
            Transform.translate(
              offset: const Offset(0, 4), // Shift text down by 2 pixels
              child: textCustom(
            ...
            Container(
              ...
              width: ConfigCustom.fixWidth_table / 3,
              height:widget.isSmall==true? ConfigCustom.odo_height_small_table_small :  ConfigCustom.odo_height_table,
              child: Stack(
                children: [
                  Positioned(
                    top: -ConfigCustom.odo_position_top_table,
                    left: 0,
                    right: 0,
                      ...
                      builder: (context, value, child) {
                        return RepaintBoundary(
                          child: SlideOdometerTransition(
                            verticalOffset:widget.isSmall==true?ConfigCustom.text_odo_letter_vertical_offset_small_table :  ConfigCustom.text_odo_letter_vertical_offset_hd_horizontal,
                            groupSeparator: Text(',', style: widget.isSmall==true?textStyleOdoSmallTable : textStyleOdoTable,),
                            decimalSeparator: Text('.', style: widget.isSmall==true?textStyleOdoSmallTable : textStyleOdoTable,),
                            letterWidth:widget.isSmall==true?ConfigCustom.text_odo_letter_width_small_table : ConfigCustom.text_odo_letter_width_hd_horizontal,
                            odometerAnimation: odometerAnimation,
                            numberTextStyle:widget.isSmall==true?textStyleOdoSmallTable : textStyleOdoTable,
                            decimalPlaces: 2,
                            integerDigits: 0,
                          ),
                        );
