...
class GameOdometerChildLed5200x1664LedFloor3Mega extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed5200x1664LedFloor3Mega({
    super.key,
  ...
  @override
  _GameOdometerChildLed5200x1664LedFloor3MegaState createState() => _GameOdometerChildLed5200x1664LedFloor3MegaState();
}

class _GameOdometerChildLed5200x1664LedFloor3MegaState extends State<GameOdometerChildLed5200x1664LedFloor3Mega> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed5200x1664LedFloor3Mega oldWidget) {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: ConfigCustom.fixWidth_ledFloor3Mega / 2,
              height: ConfigCustom.odo_height_1920x1080_ledFloor3Mega,
              child: Stack(
                children: [
                  Positioned(
                    top:  -ConfigCustom.odo_position_top_1920x1080_ledFloor3Mega,
                    left: 0,
                    right: 0,
                      ...
                      builder: (context, value, child) {
                        ...
                        return RepaintBoundary(
                          child: SlideOdometerTransition(
                            verticalOffset:  ConfigCustom.text_odo_letter_vertical_offset_1920x1080_ledFloor3Mega,
                            groupSeparator: const Text(',', style:  textStyleOdo5200x1664Floor3Mega,),
                            decimalSeparator: const Text('.', style:  textStyleOdo5200x1664Floor3Mega,),
                            letterWidth:ConfigCustom.text_odo_letter_width_1920x1080_ledFloor3Mega,
                            odometerAnimation: odometerAnimation,
                            numberTextStyle: textStyleOdo5200x1664Floor3Mega,
                            decimalPlaces: 2,
                            integerDigits: 0,
                          ),
                        );
