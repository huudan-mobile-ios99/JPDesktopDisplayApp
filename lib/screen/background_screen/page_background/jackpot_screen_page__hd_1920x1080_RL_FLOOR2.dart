...
class JackpotDisplayScreenLedRLFloor2HD extends StatefulWidget {
  const JackpotDisplayScreenLedRLFloor2HD({super.key});

  @override
  State<JackpotDisplayScreenLedRLFloor2HD> createState() => _JackpotDisplayScreenLedRLFloor2HDState();
}

class _JackpotDisplayScreenLedRLFloor2HDState extends State<JackpotDisplayScreenLedRLFloor2HD> {
          ...
          builder: (context, state) {
            return BlocBuilder<JackpotPriceBloc, JackpotPriceState>(
              ...
              builder: (context, priceState) {
                // debugPrint('Building JackpotDisplayScreenLedRLFloor2HD:${priceState.hasData}');
                return Center(
                  child: priceState.isConnected
                      ? SizedBox(
                          ...
                          // screenRLFloor2(context, hiveValues,priceState.previousJackpotValues,priceState.jackpotValues),
