...
Widget screenLedLobby(BuildContext context, Map<String, double> hiveValues,Map<String, double> prev,Map<String, double> value) {
    return Stack(
      //7 price vegas monthly weekly tripple dozen
      children: [
         Positioned(
          top: ConfigCustom.jp_vegas_screen_dY_ledLobby,
          left: ConfigCustom.jp_vegas_screen_dX_ledLobby,
        ...
        Positioned(
          top: ConfigCustom.jp_monthly_screen_dY_ledLobby,
          left: ConfigCustom.jp_monthly_screen_dX_ledLobby,
          child: JackpotOdometer(
         ...
         Positioned(
          top: ConfigCustom.jp_weekly_screen_dY_ledLobby,
          left: ConfigCustom.jp_weekly_screen_dX_ledLobby,
          child: JackpotOdometer(
        ...
        Positioned(
          top: ConfigCustom.jp_tripple_screen_dY_ledLobby,
          left: ConfigCustom.jp_tripple_screen_dX_ledLobby,
          child: JackpotOdometer(
        ...
        Positioned(
          top: ConfigCustom.jp_dozen_screen_dY_ledLobby,
          left: ConfigCustom.jp_dozen_screen_dX_ledLobby,
          child: JackpotOdometer(
        ...
        // Positioned(
        //     top: ConfigCustom.jp_highlimit_screen_dY_ledLobby,
        //     left: ConfigCustom.jp_highlimit_screen_dX_ledLobby,
        //     child: JackpotOdometer(
        ...
        //   ),
        Positioned(
            top: ConfigCustom.jp_dailygolden_screen_dY_ledLobby,
            left: ConfigCustom.jp_dailygolden_screen_dX_ledLobby,
            child: JackpotOdometer(
        ...
        Positioned(
            top: ConfigCustom.jp_daily_screen_dY_ledLobby,
            left: ConfigCustom.jp_daily_screen_dX_ledLobby,
            child: JackpotOdometer(
