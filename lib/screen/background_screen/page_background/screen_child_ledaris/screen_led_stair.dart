...
Widget screenLedStair(BuildContext context, Map<String, double> hiveValues,Map<String, double> prev,Map<String, double> value) {
    return Stack(
      //5 price vegas monthly weekly tripple dozen
      children: [
         Positioned(
          top: ConfigCustom.jp_vegas_screen_dY_ledstair,
          left: ConfigCustom.jp_vegas_screen_dX_ledstair,
        ...
        Positioned(
          top: ConfigCustom.jp_monthly_screen_dY_ledstair,
          left: ConfigCustom.jp_monthly_screen_dX_ledstair,
          child: JackpotOdometer(
         ...
         Positioned(
          top: ConfigCustom.jp_weekly_screen_dY_ledstair,
          left: ConfigCustom.jp_weekly_screen_dX_ledstair,
          child: JackpotOdometer(
        ...
        Positioned(
          top: ConfigCustom.jp_tripple_screen_dY_ledstair,
          left: ConfigCustom.jp_tripple_screen_dX_ledstair,
          child: JackpotOdometer(
        ...
        Positioned(
          top: ConfigCustom.jp_dozen_screen_dY_ledstair,
          left: ConfigCustom.jp_dozen_screen_dX_ledstair,
          child: JackpotOdometer(
