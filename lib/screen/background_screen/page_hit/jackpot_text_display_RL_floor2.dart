...
class JackpotTextDisplayFullRLFloor2 extends StatelessWidget {
  final String number;
  final String value;

  const JackpotTextDisplayFullRLFloor2({
    super.key,
    ...
    return Column(
      ...
      children: [
         Text(
            "CONGRATULATION",
            style: TextStyle(
              fontSize: ConfigCustom.text_hit_price_size_1920x1080_RL_floor2 * scale,
              color: Colors.white,
