...
class JackpotBackgroundVideoHitLedHD1920x1080NonSmoke extends StatefulWidget {
  ...
  const JackpotBackgroundVideoHitLedHD1920x1080NonSmoke({
    super.key,
  ...
  @override
  _JackpotBackgroundVideoHitLedHD1920x1080NonSmokeState createState() => _JackpotBackgroundVideoHitLedHD1920x1080NonSmokeState();
}

class _JackpotBackgroundVideoHitLedHD1920x1080NonSmokeState extends State<JackpotBackgroundVideoHitLedHD1920x1080NonSmoke>
   {
  ...
  @override
  void didUpdateWidget(JackpotBackgroundVideoHitLedHD1920x1080NonSmoke oldWidget) {
    ...
    SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            left: ConfigCustom.text_hit_price_dX_1920x1080_non_smoke,
            top: ConfigCustom.text_hit_price_dY_1920x1080_non_smoke,
            child: Container(
              ...
              child: Text(
                ...
                style: textStyleJPHit1920x1080_Non_Smoke,
          ...
          widget.value == '0.00' || widget.value == '0' || widget.value == '0.0'?
          Positioned(
            top:ConfigCustom.text_hit_number_dY_1920x1080_only_hotseat_non_smoke,
            left:ConfigCustom.text_hit_number_dX_1920x1080_only_hotseat_non_smoke,
            child: Text(
              widget.number,
              style:textStyleJPHit1920x1080SmallOnlyHotSeat_Non_Smoke
            ),
          )
          :
          Positioned(
            top:ConfigCustom.text_hit_number_dY_1920x1080_non_smoke,
            left:ConfigCustom.text_hit_number_dX_1920x1080_non_smoke,
            child: Text(
              '#${widget.number}',
              style:textStyleJPHit1920x1080Small_Non_Smoke,
            ))
              ],
                );
                }
