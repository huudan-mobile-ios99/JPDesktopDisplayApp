...
class JackpotHitShowScreen5200x1664Led3MegaNoBG extends StatelessWidget {
  const JackpotHitShowScreen5200x1664Led3MegaNoBG({super.key});
  @override
        ...
        child: BlocSelector<JackpotBloc2, JackpotState2, ({Map<String, dynamic>? hitData, bool requiresCountdown})>(
          ...
          builder: (context, data) {
            ...
            if (ConfigCustom.defaultJackpotValues.containsKey(hitId)) {
             ...
             return JackpotBackgroundVideoHit5200x1664LedFloor3MegaNoBG(
