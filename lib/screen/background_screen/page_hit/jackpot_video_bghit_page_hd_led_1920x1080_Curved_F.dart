...
class JackpotBackgroundVideoHitLedHD1920x1080CurvedF extends StatefulWidget {
  final String number;
  final String value;
  final String id;

  const JackpotBackgroundVideoHitLedHD1920x1080CurvedF({
    super.key,
  ...
  @override
  _JackpotBackgroundVideoHitLedHD1920x1080CurvedFState createState() => _JackpotBackgroundVideoHitLedHD1920x1080CurvedFState();
}

class _JackpotBackgroundVideoHitLedHD1920x1080CurvedFState extends State<JackpotBackgroundVideoHitLedHD1920x1080CurvedF>
   {
...
final  JackpotConfigService _configService = JackpotConfigService();
  ...
  String getVideoAssetPath(String id) {
    final String path = _configService.getHitVideoPathLedCurved(id);
  ...
  //       return ConfigCustom.jp_id_hit_all_ledcurved;
  //     case '48':
  //       return ConfigCustom.jp_id_hit_all_ledcurved; //New JP hightlimit
  //     case '18':
  //       return ConfigCustom.jp_id_hit_all_ledcurved;
  ...
  @override
  void didUpdateWidget(JackpotBackgroundVideoHitLedHD1920x1080CurvedF oldWidget) {
    ...
    SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            left: ConfigCustom.text_hit_price_dX_1920x1080_curved,
            top:  ConfigCustom.text_hit_price_dY_1920x1080_curved,
            child: Container(
          ...
          widget.value == '0.00' || widget.value == '0' || widget.value == '0.0'?
          Positioned(
            top:ConfigCustom.text_hit_number_dY_1920x1080_only_hotseat_curved,
            left:ConfigCustom.text_hit_number_dX_1920x1080_only_hotseat_curved,
            child: Text(
              widget.number,
          ...
          :
          Positioned(
            top:ConfigCustom.text_hit_number_dY_1920x1080_curved,
            left:ConfigCustom.text_hit_number_dX_1920x1080_curved,
            child: Text(
              '#${widget.number}',
