...
import 'package:playtech_transmitter_app/screen/background_screen/page_hit/jackpot_video_bghit_page_led_1920x1080_LedFloor3Mega_BACK.dart';
...
class JackpotHitShowScreen5200x1664Led3MegaBACK extends StatelessWidget {
  const JackpotHitShowScreen5200x1664Led3MegaBACK({super.key});
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: JackpotBackgroundVideoHit1920x1080LedFloor3MegaBACK(
              id: '121',
              number: '1234',
              value: '1000',
      ),
        ...
        child: BlocSelector<JackpotBloc2, JackpotState2, ({Map<String, dynamic>? hitData, bool requiresCountdown})>(
          ...
          builder: (context, data) {
            ...
            if (ConfigCustom.defaultJackpotValues.containsKey(hitId)) {
             ...
             return JackpotBackgroundVideoHit1920x1080LedFloor3MegaBACK(
