...
class JackpotBackgroundVideoHitLedHD1920x1080StairF extends StatefulWidget {
  ...
  const JackpotBackgroundVideoHitLedHD1920x1080StairF({
    super.key,
  ...
  @override
  _JackpotBackgroundVideoHitLedHD1920x1080StairFState createState() => _JackpotBackgroundVideoHitLedHD1920x1080StairFState();
}

class _JackpotBackgroundVideoHitLedHD1920x1080StairFState extends State<JackpotBackgroundVideoHitLedHD1920x1080StairF>
   {
  ...
  @override
  void didUpdateWidget(JackpotBackgroundVideoHitLedHD1920x1080StairF oldWidget) {
  ...
  Future<void> _loadVideo(String videoPath) async {
    ...
    try {
      await _player.pause();
      await Future.delayed(const Duration(milliseconds: 10)); // Delay to stabilize libmpv
