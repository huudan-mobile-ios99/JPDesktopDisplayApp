...
class JackpotBackgroundVideoHitLedHD1920x1080ATM extends StatefulWidget {
  final String number;
  final String value;
  final String id;

  const JackpotBackgroundVideoHitLedHD1920x1080ATM({
    super.key,
  ...
  @override
  _JackpotBackgroundVideoHitLedHD1920x1080ATMState createState() => _JackpotBackgroundVideoHitLedHD1920x1080ATMState();
}

class _JackpotBackgroundVideoHitLedHD1920x1080ATMState extends State<JackpotBackgroundVideoHitLedHD1920x1080ATM>
   {
  ...
  String getVideoAssetPath(String id) {
    final String path = _configService.getHitVideoPathLedATM(id);
  ...
  @override
  void didUpdateWidget(JackpotBackgroundVideoHitLedHD1920x1080ATM oldWidget) {
